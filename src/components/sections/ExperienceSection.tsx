      ...
      <Container>
        <div className="space-y-10">
          <SectionTitle
            ...
            description="Built and stabilized mission-critical financial workflows, internal tools, and reusable UI systems—improving release reliability, operational efficiency, and delivery speed in a regulated environment."
          />
          <div className="space-y-6">
            {experiences.slice(0, 1).map((experience) => (
              <article
                key={`${experience.company}-${experience.role}`}
                className="rounded-[1.75rem] border border-white/10 bg-panel p-7 shadow-glow"
              >
